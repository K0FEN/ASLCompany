  ...
  sections.forEach((section) => {
    ...
    viewAllBtn.addEventListener('click', (e) => {
      ...
      const categoryBackgrounds = {
        ...
        'Мастила': 'Materials/ed35faa954b465a3c3ff55526ad27c12.jpg'
      };
      
      const categoryDescription = categoryDescriptions[categoryName] || 'Широкий вибір продукції від провідних виробників.';
      const categoryBackground = categoryBackgrounds[categoryName] || 'Materials/fonassortiment.jpg';
      ...
      const html = `<!doctype html><html lang="uk"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${title} - ASL Company</title><link rel="stylesheet" href="css/style.css?v=4" /><link rel="stylesheet" href="css/responsive-new.css?v=6" /><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/lipis/flag-icons@7.2.3/css/flag-icons.min.css" /></head><body>
        ...
        <header class="header">
          <div class="header__container">
            <a href="index.html" class="header__logo logo"><img src="Materials/erasebg-transformed.png" alt="ASL Company logo" /></a>
...
function initBrandPage() {
  ...
  window.brandsData = {
    ...
    'Kixx': {
      name: 'Kixx',
      image: 'Materials/Kixx.png',
      factoryLogo: 'Materials/GS Caltex.jpg',
      productImage1: 'Materials/K1.jpg',
      productImage2: 'Materials/K2.jpg',
    ...
    'Автохіт': {
      ...
      factoryLogo: '',
      productImage1: 'Materials/AT21.jpg',
      productImage2: 'Materials/AT22.jpg',
    ...
    'NAC': {
      name: 'NAC',
      image: 'Materials/NAC.png',
      factoryLogo: 'Materials/NAC.png',
      productImage1: '',
      productImage2: '',
    ...
    'Quantum': {
      ...
      productImage1: 'Materials/Q11.jpg',
      productImage2: 'Materials/Q12.jpg',
    ...
    'FORSE': {
      name: 'Force Racing',
      image: 'Materials/Forse.jpg',
      factoryLogo: 'Materials/WESTA.png',
      productImage1: 'Materials/F1.jpg',
      productImage2: 'Materials/F2.jpg',
      website: 'https://westa.ua/ua',
      description: 'Force Racing - це надійна лінійка акумуляторів, призначених для забезпечення надійної та стабільної енергії для вашого автомобіля. Як офіційний імпортер Force Racing в Україні, ми представляємо вам цей продукт, який об`єднує якість і доступність. Давайте розглянемо ключові переваги акумулятора, а також принцип його роботи:\n\nОсобливості лінійки "Force Racing":\n\nЕкономічне рішення:\n\nАкумулятори Force Racing являють собою ідеальне економічне рішення для автовласників, які цінують надійність без зайвих витрат. Вони надають доступ до високоякісного акумулятора за доступною ціною.\n\nНадійність Force Racing:\n\nБренд Force Racing відомий своєю надійністю та якістю продукції. Це гарантує, що акумулятор служитиме довго і надійно, навіть в умовах підвищених навантажень.\n\nПростота в обслуговуванні:\n\nАкумулятор Force Racing розроблений з урахуванням зручності в обслуговуванні. Він має простий і надійний дизайн, що робить його ідеальним вибором для автовласників, які віддають перевагу самостійному обслуговуванню.\n\nСтабільне Енергопостачання:\n\nАкумулятор Force Racing забезпечує стабільне і безпечне енергопостачання для запуску двигуна і роботи електроніки вашого автомобіля. Ви можете бути впевнені, що ваш автомобіль завжди готовий до дорожніх пригод.'
    },
    'FEON': {
      name: 'FEON',
      image: 'Materials/Feon.jpg',
      factoryLogo: 'Materials/ISTA.png',
      productImage1: 'Materials/Fe1.jpg',
      productImage2: 'Materials/Fe2.jpg',
      website: 'http://ista.com.ua/ua/',
      description: 'Акумулятори Feon - це високотехнологічний АКБ при виробництві якого застосовуються спеціальні домішки кальцію. Ця модель має відмінну якість і має доступну ціну. Батарею можна встановлювати на вантажні авто, автобуси та сільськогосподарську техніку різних марок. Крім цього, акумулятор стійкий до агресивного середовища та глибоких розрядів, а також до вібрацій. За низьких і високих температур зберігає високі показники пускового струму.\n\nЩодо безпеки, то за це в акумуляторі відповідає блок сепараторів, які захищають батарею від коротких замикань. В АКБ FEON застосована гібридна технологія, де литі грати позитивного електрода виготовляються за мало сурм`янистою технологією, а також негативний електрод виготовлений за технологією Expanded Metal. Це дозволяє значно покращити електричні характеристики акб за низьких температур.\n\nАвто акумулятор оснащений свинцевими пластинами, які виготовлені з додаванням таких добавок:\n\n1. Сурма - до 2%\n\n2. Селен - до 0,02%\n\n3. Кальцій – до 0,1%\n\nЩо з цього випливає, добавки дозволяють значно підвищити стійкість пластин до корозії, але свинець залишається максимально чистим. Технології C++ грати пластин не відливаються, а прокочуються. Внаслідок чого свинцеві пластини набагато краще тримають заряд, і підвищується стійкість до саморуйнування. Термін служби збільшується майже в 1,5 рази, порівняно з батареями, виготовленими за звичайною технологією.\n\nПереваги FEON:\n\nВисока вібростійкість;\n\nХороші показники пускового струму за низьких температур;\n\nЗахист від неправильної полярності;\n\nЗахист від великих навантажень; Захист від замикання;\n\nДостатній запас ємності;\n\nВисока якість за доступної ціни.'
    },
    'Topla': {
      name: 'Topla',
      image: 'Materials/Topla.jpg',
      factoryLogo: 'Materials/ТАВ.png',
      productImage1: 'Materials/To1.jpg',
      productImage2: 'Materials/To2.jpg',
      website: 'https://www.tab.si/ru/',
      description: 'Акумулятори Topla – є надійним джерелом живлення. Вироблений у Словенії і перевірений українськими дорогами і кліматом. Показником якості і надійності даної моделі є – відмінні показники роботи, стабільність утримання заряду і високе віддавання за струмом.\n\nПереваги:\n\nАбсолютно необслуговуваний акумулятор з низькою витратою води.\n\nСистема перфорації «Expanded Metal Technology» збільшує площу електродів і дозволяє досягти високого пускового струму.\n\nВпевнено працює від -50°С до + 60°С.\n\nГерметизація корпусу акумулятора виключає витікання електроліту під капот або в салон автомобіля, як при русі бездоріжжям, так і при перегріванні.\n\nМінімальне саморозряджання в умовах простою або тривалого зберігання.\n\nШвидкий прийом заряду.'
    },
    'VEGA': {
      name: 'VEGA',
      image: 'Materials/vega.png',
      factoryLogo: 'Materials/WESTA.png',
      productImage1: 'Materials/V1.jpg',
      productImage2: 'Materials/V2.jpg',
      website: 'https://westa.ua/ua',
      description: 'Акумулятори «Vega» мають гібридну технологію, при використанні якої, решітки позитивних і негативних електродів виготовляються з різних сплавів.\n\nГрати позитивних електродів, виготовлені з свинцево-сурм`янистого сплаву, мають високу міцність, корозійну стійкість, добре переносять глибокі розряди.\n\nГрати негативних електродів, виготовлені з свинцево-кальцієвого сплаву, мають меншу питому вагу, мають низький опір, нейтральні до води.\n\nВ результаті застосування даної комбінації отримані універсальні акумулятори, найкращим чином поєднують в собі переваги двох технологій. Високі пускові струми, полегшують пуск двигунів в умовах низьких температур. Стійкі до глибокого розряду, менш чутливі до перепадів бортової напруги.\n\nШвидке відновлення заряду.\n\nРадіальний профіль решітки позитивного електрода покращує прийом заряду.'
    },
    'WPR': {
      name: 'WPR',
      image: 'Materials/WPR.jpg',
      factoryLogo: 'Materials/WESTA.png',
      productImage1: 'Materials/WP1.jpg',
      productImage2: 'Materials/WP2.jpg',
      website: 'https://westa.ua/ua',
      description: 'Акумулятори WPR (ВЕСТА Преміум) – це лінійка якісних автомобільних акумуляторів українського виробництва, розроблених для автомобілів з підвищеним споживанням енергії та для суворих кліматичних умов, що відрізняються високим пусковим струмом, покращеною стійкістю до розрядів і тривалим терміном служби завдяки застосуванню кальцієво-свинцевого сплаву та лабіринтової кришки. Вони позиціонуються як преміальний продукт із підвищеною надійністю, розроблений українським виробником МНПК «ВЕСТА».\n\nОсновні характеристикиТип:\n\nСвинцево-кислотні, кальцієві (Ca/Ca).\n\nЗначення: Легкові автомобілі, особливо ті, що вимагають більше енергії або експлуатуються в складних умовах (мороз, вібрація).\n\nПереваги:\n\nВисокий пусковий струм (на ~30% вищий за стандартні).Підвищена ємність та стійкість до розрядів.\n\nНизький саморозряд під час простою.\n\nДовгий ресурс пусків та загальний термін служби.\n\nМінімальна втрата рідини завдяки лабіринтовій кришці та пламегасникам.\n\nТехнологія: використовують запатентований кальцієво-свинцевий сплав з високим вмістом олова, що підвищує стійкість до корозії.'
    },
    'STARTUP': {
      name: 'START UP',
      image: 'Materials/STARTUP.png',
      factoryLogo: 'Materials/WESTA.png',
      productImage1: 'Materials/ST1.jpg',
      productImage2: 'Materials/ST2.jpg',
    ...
    'autopart': {
      name: 'AutoPart',
      image: 'Materials/autopart.jpg',
      factoryLogo: 'Materials/atp3.jpg',
      productImage1: 'Materials/AP1.jpg',
      productImage2: 'Materials/AP2.jpg',
    ...
    'Piton': {
      name: 'PiTon',
      image: 'Materials/Piton.jpg',
      factoryLogo: 'Materials/P3.jpg',
      productImage1: 'Materials/P1.jpg',
      productImage2: 'Materials/P2.jpg',
    ...
    'ProfiMax': {
      name: 'PROFI MAX',
      image: 'Materials/ProfiMax.jpg',
      factoryLogo: 'Materials/MFC.jpg',
      productImage1: 'Materials/PM1.jpg',
      productImage2: 'Materials/PM2.jpg',
    ...
    'Active': {
      ...
      productImage2: 'Materials/A2.jpg',
      website: 'https://mfc.com.ua/uk/',
      description: 'Антифриз бренду MFC — це високоякісна охолоджувальна рідина, виготовлена за органічною технологією. Призначений для використання в системах охолодження бензинових і дизельних двигунів легкових і вантажних автомобілів, а також спецтехніки. Продукт ефективно захищає двигун від перегріву, замерзання, корозії, утворення накипу та кавітації.\n\nПереваги антифризу бренду MFC:\n\nВідповідає стандарту G12 (OAT).\nЗахищає до -26°C і до +108°C.\nНе містить шкідливих домішок: фосфатів, нітритів, силікатів.\nДо 5 років стабільної роботи системи охолодження.\nВироблено в Україні з дотриманням європейських норм.\nПоставляється у зручній міцній пластиковій каністрі.\n\nРекомендації щодо використання:\n\nНе сумісний  з іншими класами та кольорами — змішування може знизити ефективність захисту.\nЗаміна рідини рекомендується через 5 років або після 150 000 км.\nПеред заливкою важливо промити систему охолодження, особливо при переході з іншого класу рідини.\nНе доливайте воду — рідина вже готова до використання.\nНе відкривайте кришку радіатора на гарячому двигуні — це може бути небезпечно!\n\nАнтифриз бренду MFC — надійний вибір для довготривалого захисту вашого двигуна в будь-яку пору року.'
    },
    'Тайфун': {
      name: 'Тайфун',
      image: 'Materials/Tayphun.jpg',
      factoryLogo: 'Materials/MFC.jpg',
      productImage1: 'Materials/T1.jpg',
      productImage2: 'Materials/T2.jpg',
      website: 'https://mfc.com.ua/uk/',
    ...
    'NAVIGATOR': {
      name: 'Navigator',
      image: 'Materials/NAVIGATOR.jpg',
      description: 'Navigator — якісні охолоджуючі рідини та антифризи. Продукція відзначається стабільними характеристиками та доступною ціною.\n\nШирокий вибір антифризів різних кольорів та специфікацій.'
    },
    'Експо Хім': {
      name: 'Експо Хім',
      image: 'Materials/Експо Хім.jpg',
      description: 'Експо Хім — український виробник технічних рідин. Продукція включає антифризи, гальмівні рідини та інші технічні засоби.\n\nДоступні ціни та перевірена якість.'
    },
    'Plax': {
      name: 'Plax',
      image: 'Materials/Plax.jpg',
      description: 'Plax — бренд охолоджуючих рідин та антифризів. Продукція забезпечує ефективне охолодження двигуна.\n\nЯкісні антифризи за доступними цінами.'
    },
    'МFC': {
      name: 'MFC',
      image: 'Materials/МFC.jpg',
      description: 'MFC — виробник охолоджуючих рідин та технічних засобів. Продукція відзначається надійністю та ефективністю.\n\nШирокий асортимент для різних потреб.'
    },
    // Фільтри
    'AF Alpha': {
      name: 'AF ALPHA',
      image: 'Materials/AF Alpha.jpg',
      factoryLogo: 'Materials/AF3.webp',
      productImage1: 'Materials/AF1.jpg',
      productImage2: 'Materials/AF2.jpg',
    ...
    'Knecht': {
      name: 'KNECHT',
      image: 'Materials/Knecht.jpg',
      factoryLogo: 'Materials/KN3.jpg',
      productImage1: 'Materials/KN1.png',
      productImage2: 'Materials/KN2.jpg',
    ...
    'Shikoo': {
      name: 'SHIKOO',
      image: 'Materials/Shikoo.jpg',
      factoryLogo: 'Materials/Shikoo.jpg',
      productImage1: 'Materials/SH1.jpg',
      productImage2: 'Materials/SH2.jpg',
    ...
    'Temol': {
      ...
      factoryLogo: 'Materials/TM3.jpg',
      productImage1: 'Materials/TM1.png',
      productImage2: 'Materials/TM2.png',
    ...
    'AVIS1': {
      name: 'AVIS',
      image: 'Materials/AVIS.jpg',
      factoryLogo: 'Materials/AVIS.jpg',
      productImage1: 'Materials/AV22.jpg',
      productImage2: 'Materials/AV21.jpg',
    ...
    'Venol-brakes': {
      name: 'VENOL DOT 4',
      image: 'Materials/Venol.png',
      factoryLogo: 'Materials/VenolBr3.jpg',
      productImage1: 'Materials/VE31.jpg',
      productImage2: 'Materials/VE32.jpg',
    ...
    'ADVA-brakes': {
      ...
      image: 'Materials/ADVA.jpg',
      factoryLogo: 'Materials/ADV3.jpg',
      productImage1: 'Materials/AD11.jpg',
      productImage2: 'Materials/AD22.jpg',
    ...
    'Експо Хім-brakes': {
      ...
      image: 'Materials/Експо Хім.jpg',
      factoryLogo: 'Materials/Експо Хім.jpg',
      productImage1: 'Materials/EX1.jpg',
      productImage2: 'Materials/EX2.jpg',
    ...
    'Автохіт-brakes': {
      ...
      productImage1: 'Materials/AT31.jpg',
      productImage2: 'Materials/AT32.jpg',
    ...
    'Кама-brakes': {
      ...
      image: 'Materials/KAMA.png',
      factoryLogo: 'Materials/KAMA.png',
      productImage1: 'Materials/KM21.jpg',
      productImage2: 'Materials/KM22.jpg',
    ...
    'High Way-brakes': {
      name: 'High Way DOT 4',
      image: 'Materials/Highway.png',
      factoryLogo: 'Materials/Highway.png',
      productImage1: '',
      productImage2: '',
      description: 'High Way – бренд гальмівних рідин від міжнародної асоціації Delfin Group. Продукція забезпечує надійну роботу гальмівних систем та відповідає найвищим стандартам якості.\n\nГальмівні рідини High Way розроблені для забезпечення безпеки та ефективності гальмування в різних умовах експлуатації.'
    },
    // Охолоджуючі рідини  
    'Alyaska-coolants': {
      name: 'АЛЯSКА',
    ...
    'Venol-coolants': {
      name: 'VENOL',
      image: 'Materials/Venol1.jpg',
      factoryLogo: 'Materials/VenAF3.jpg',
      productImage1: 'Materials/VE11.jpg',
      productImage2: 'Materials/VE22.jpg',
    ...
    'Advantage': {
      name: 'Advantage',
      image: 'Materials/ADVANTAGE.png',
      factoryLogo: 'Materials/ADVANTAGE.png',
      productImage1: '',
      productImage2: '',
  ...
  const categoryBackgrounds = {
    'batteries': 'Materials/AKM.jpg',
    'oils': 'Materials/oil.jpg',
    'chem': 'Materials/Avtohim.jpg',
    'coolants': 'Materials/Antifriz.jpg',
    'brakes': 'Materials/tormoz.jpg',
    'filters': 'Materials/filter.jpg',
    'washer': 'Materials/steklo.jpg',
    'greases': 'Materials/ed35faa954b465a3c3ff55526ad27c12.jpg'
  };
  ...
  if (brandLogoElement) {
    brandLogoElement.src = brandData.image || 'img/home/services_placeholder.jpg';
  ...
  if (factoryLogoElement) {
    factoryLogoElement.src = brandData.factoryLogo || brandData.image || 'img/home/services_placeholder.jpg';
  ...
  if (productImage1) {
    productImage1.src = brandData.productImage1 || brandData.image || 'img/home/services_placeholder.jpg';
    productImage1.alt = `${brandData.name} продукція 1`;
  }

  const productImage2 = document.getElementById('product-image-2');
  if (productImage2) {
    productImage2.src = brandData.productImage2 || brandData.image || 'img/home/services_placeholder.jpg';
